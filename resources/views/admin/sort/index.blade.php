    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <a type="button" class="btn btn-block btn-info" href="/setAdmin/video/sort/add">添加分類</a>
                <!-- /.box-header -->
                <div class="box-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td width="200">
                                <a type="button" class="btn btn-info" href="/setAdmin/video/sort/edit/{{ $val->id }}">編輯</a>
...
<script>
    $(function () {
        $(".btn-danger").click(function () {
            id = $(this).data();
            _this = $(this);
            $.get( "/api/setAdmin/video/sort/delete/" + id.id, function(data) {
