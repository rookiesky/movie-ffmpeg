    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <a type="button" class="btn btn-block btn-info" href="/setAdmin/notices/create">添加通知</a>
                <!-- /.box-header -->
                <div class="box-body">
                    <table class="table table-bordered">
                        ...
                        @foreach($notices as $val)
                            <tr>
                                ...
                                <td width="200">
                                    <a type="button" class="btn btn-info" href="/setAdmin/notices/{{ $val->id }}/edit/">編輯</a>
